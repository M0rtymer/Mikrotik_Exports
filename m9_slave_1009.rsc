# jan/02/1970 03:03:45 by RouterOS 6.44
# software id = FD8S-50VR
#
# model = CCR1009-7G-1C-1S+
# serial number = 914F0A5B61AA
/interface bridge
...
/ip dhcp-server
add address-pool=dhcp_pool0 interface=vlan200 name=dhcp1
/ppp profile
...
/ip address
add address=192.168.200.1/24 disabled=yes interface=vlan200 network=\
    192.168.200.0
add address=10.10.10.1/29 comment=Master disabled=yes interface=ether7 \
    network=10.10.10.0
...
add address=92.62.112.192/25 disabled=yes interface=ether1 network=\
    92.62.112.128
add address=10.10.10.2/29 comment=Slave interface=ether7 network=10.10.10.0
